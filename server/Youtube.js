...
// Collection of helpers to fetch data from youtube bypassing the official API (eg rate limiting etc)
...
export const GetYoutubeInitData = async (url) => {
  ...
  export const GetData = async (keyword, withPlaylist = false, limit = 0) => {
